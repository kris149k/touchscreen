...
const artifactData = [
...

    {
        ...
        manualScale: 8,
        hotspots: [
            { position: new THREE.Vector3(-1, 4, 0.1), title: "Buckingham Palace", content: "Description for detail A of object 2." },
            { position: new THREE.Vector3(-1, 0, 3), title: "Detail B", content: "Description for detail B of object 2." },
            { position: new THREE.Vector3(-8, 0, 0), title: "Detail C", content: "Description for detail C of object 2." }
        ]
    },
